...
const Dashboard: React.FC = () => {
  ...
  return (
    <main className="bg-background h-full overflow-y-auto" style={{ backgroundImage: "url('/background.png')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
